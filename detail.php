                            ...
                            <div class="movie--actor">
                                ...
                                <div class="slide--actor">
                                    ...
                                    <div class="info--actor">
                                            <?php $getActor = $move->getActor($id);
                                                foreach ($getActor as $value_actor):
                                            ?>
                                        <div class="nameimg--info">
                                            <a href="">
                                                <img class="img--actor" src="./img/<?php echo $value_actor['img'] ;?>" alt="">
                                                <div class="name--actor"><?php echo $value_actor['name']?></div>
                                            </a>
                                        </div>
                                                    <?php endforeach; ?>
                                    </div>
